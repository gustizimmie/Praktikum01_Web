...
<div id="pesan" class="row mb-3">
	<div class="col">
		...
		<?php
		        ...
		        $insertSQL = "INSERT INTO penggajian (karyawan_nik, bulan, tahun, gajih_pokok) VALUES ('$karyawan_nik', '$bulan_select', '$tahun', '$gajih_pokok')";
		...
		<div class="card px-3">
			...
			<div class="row">
				...
				<div class="col-md-6 mb-3 mt-3">
					...
					<input type="text" class="form-control" value="<?php echo $row["gajih_pokok"] ?>" readonly>
				</div> 
			</div> 	
			<div class="row">
...
<div class="card px-3 mt-3">
			<form action="" method="post">
				...
				<input type="hidden" name="gajih_pokok" value="<?= $row["gajih_pokok"] ?>">
				<div class="mb-3 mt-3">
